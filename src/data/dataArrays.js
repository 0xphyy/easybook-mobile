export const categories = [
  {
    ...
    name: "BIOGRAFI",
    photo_url:
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
  },
  {
    id: 1,
    name: "DRAMA",
...
export const recipes = [
  {
    ...
    description:
      'Ekologi Serangga Tropis: Keanekaragaman dan Peranannya dalam Ekosistem" oleh \n\n Dr. Maria Rodriguez: Buku ini merupakan karya ilmiah yang mendalam tentang ekologi serangga di habitat tropis. Dr. Rodriguez menggambarkan secara rinci bagaimana serangga berperan sebagai komponen utama dalam menjaga keseimbangan ekosistem tropis. Dengan memberikan contoh konkret dan penelitian terkini, buku ini membantu pembaca memahami kompleksitas hubungan antara serangga, tumbuhan, dan faktor lingkungan lainnya di dalam hutan tropis yang beragam.',
  },
  {
    recipeId: 3,
    categoryId: 3,
    title: "Anatomi dan Fisiologi Serangga",
    photo_url:
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    photosArray: [
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    ...
    description:
      '"Anatomi dan Fisiologi Serangga" oleh Prof. John Smith: Buku ini merupakan referensi penting bagi para ilmuwan dan mahasiswa yang tertarik pada anatomi dan fisiologi serangga. Prof. Smith secara sistematis menjelaskan struktur tubuh serangga mulai dari kepala hingga abdomen, serta fungsi setiap bagian tubuh dalam menjalankan aktivitas harian serangga. Dengan ilustrasi yang jelas dan tulisan yang mudah dipahami, buku ini menjadi panduan lengkap untuk memahami bagaimana serangga beradaptasi dengan lingkungannya melalui perangkat anatomi dan fisiologi yang unik.',
  },
  {
    recipeId: 2,
    categoryId: 3,
    title: "Perilaku Reproduksi Serangga",
    photo_url:
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    photosArray: [
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    ...
    description:
      '"Perilaku Reproduksi Serangga: Strategi, Pola, dan Evolusi" oleh Dr. Anna Lee: Dalam buku ini, Dr. Lee membahas beragam aspek perilaku reproduksi serangga yang menarik dan penting untuk dipahami. Dari pemilihan pasangan hingga perawatan terhadap keturunan, pembaca diajak untuk memahami kompleksitas strategi reproduksi yang digunakan oleh berbagai spesies serangga. Dengan menggabungkan penelitian lapangan dengan pemahaman teoritis tentang evolusi, buku ini menghadirkan wawasan yang mendalam tentang bagaimana perilaku reproduksi serangga berkembang seiring waktu dan dalam konteks lingkungan yang berubah.',
  },
  {
    recipeId: 3,
    categoryId: 3,
    title: "Pengendalian Serangga Tanaman",
    photo_url:
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    photosArray: [
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    ...
    description:
      '"Pengendalian Serangga Tanaman: Pendekatan Terbaru dalam Perlindungan Tanaman" oleh Prof. David Johnson. Buku ini mengulas teknik terkini dalam pengendalian serangga tanaman secara efektif dan berkelanjutan. Dari penggunaan agen biologis hingga metode pemantauan terkini, pembaca akan mendapatkan wawasan tentang bagaimana melindungi tanaman dari kerusakan serangga tanpa merusak lingkungan.',
  },
  {
    recipeId: 1,
    categoryId: 3,
    title: "Biologi Evolusioner Serangga",
    photo_url:
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    photosArray: [
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    ...
    description:
      '"Biologi Evolusioner Serangga: Mekanisme dan Konsekuensi Evolusi" oleh Dr. Emily Brown. Buku ini mengeksplorasi konsep evolusi dalam konteks serangga, termasuk adaptasi morfologi, genetik populasi, dan spesiasi. Pembaca akan memahami bagaimana tekanan seleksi alam membentuk keragaman besar serangga yang kita amati hari ini, serta implikasinya bagi pemahaman kita tentang evolusi secara umum.',
  },
  {
    recipeId: 4,
    categoryId: 1,
    title: "Sejarah Drama Barat",
    photo_url:
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    photosArray: [
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    ...
    description:
      '"Sejarah Drama Barat: Dari Klasik Hingga Kontemporer" oleh Prof. Elizabeth Johnson: Buku ini menyajikan tinjauan komprehensif tentang perkembangan drama Barat dari zaman klasik hingga era kontemporer. Prof. Johnson menguraikan perubahan dramatis dalam konteks sejarah, budaya, dan perkembangan sosial, memperkenalkan pembaca pada karya-karya penting dari Shakespeare hingga dramawan modern seperti Tennessee Williams dan Harold Pinter. Melalui analisis yang mendalam dan wawasan yang kuat, buku ini membawa pembaca dalam perjalanan yang menggugah untuk memahami evolusi genre dramatis.',
  },
  {
    recipeId: 5,
    categoryId: 1,
    title: "Teori Drama Modern:",
    photo_url:
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    photosArray: [
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    ...
    description:
      '"Teori Drama Modern: Pendekatan Kritis dan Analisis Sastra" oleh Dr. Michael Brown: Buku ini mengeksplorasi teori-teori dramatik modern yang membentuk landasan kritis bagi pemahaman dan interpretasi karya-karya teater kontemporer. Dr. Brown membahas berbagai pendekatan kritis, mulai dari strukturalisme hingga postmodernisme, dan menerapkannya pada analisis karya-karya dramatis terkemuka. Dengan bahasa yang jelas dan contoh yang kuat, buku ini memperkenalkan pembaca pada kerangka pemikiran yang diperlukan untuk memahami kompleksitas drama modern.',
  },
  {
    recipeId: 6,
    categoryId: 2,
    title: "Panduan Menulis Fantasi Epik",
    photo_url:
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    photosArray: [
      "https://9f2c1h9v-3000.asse.devtunnels.ms/buku/image/COVER_Palace%20Pets%20Storybook%20Collection.png",
    ...
    description:
      '"Panduan Menulis Fantasi Epik: Membangun Dunia yang Memikat" oleh Dr. Emily White: Buku ini adalah panduan praktis bagi para penulis yang ingin menciptakan karya fantasi epik yang memikat. Dr. White membahas berbagai aspek penting dalam pembangunan dunia fantasi, mulai dari penciptaan sistem sihir hingga pengembangan karakter yang kuat. Dengan memberikan contoh konkret dan latihan latihan kreatif, buku ini menjadi sumber inspirasi yang berharga bagi mereka yang ingin menjelajahi dunia fantasi yang luas dan mendalam.',
  },
];
